...
export const TEXT = {
  en: {
    ...
    pveDescription: "Choose a side and play against the AI", pveSidePrompt: "Your side will appear at the bottom of the board.", onlinePvp: "Online PvP", pvpDescription: "Create or join a private network room",
    ...
    undo: "Undo Last Move", newGame: "New Game", settings: "Settings", close: "Close", resetSpecialHelp: "Show special-unit explanations again", specialHelpReset: "Special-unit explanations will be shown again.", redUnits: "Black units", blueUnits: "White units",
    ...
    roomWaiting: "Room {room}. Waiting for opponent…", sideSelectionReady: "Room {room} · Opponent joined. Choose Black or White.", roomPlayer: "Room {room} · You are {side}.",
  ...
  ko: {
    ...
    pveDescription: "진영을 선택하여 AI와 대결", pveSidePrompt: "선택한 내 진영이 보드 아래쪽에 표시됩니다.", onlinePvp: "온라인 PvP", pvpDescription: "비공개 방을 만들거나 참가",
    ...
    undo: "마지막 수 되돌리기", newGame: "새 게임", settings: "환경설정", close: "닫기", resetSpecialHelp: "특수 유닛 설명 다시 표시", specialHelpReset: "특수 유닛 설명이 다시 표시됩니다.", redUnits: "흑 유닛", blueUnits: "백 유닛",
    ...
    roomWaiting: "{room} 방에서 상대를 기다리는 중…", sideSelectionReady: "{room} 방 · 상대가 참가했습니다. 흑 또는 백을 선택하세요.", roomPlayer: "{room} 방 · 나의 진영: {side}",
