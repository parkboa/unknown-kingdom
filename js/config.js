...
export const TEXT = {
  en: {
    ...
    enterCode: "Enter code", createRoom: "Create Room", joinRoom: "Join Room", playOnlineBot: "Play Online Bot", back: "Back", specialUnit: "Special Unit",
  ...
  ko: {
    ...
    enterCode: "코드 입력", createRoom: "방 만들기", joinRoom: "방 참가", playOnlineBot: "온라인 봇 대전", back: "뒤로", specialUnit: "특수 유닛",
