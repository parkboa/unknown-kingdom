...
export const TEXT = {
  en: {
    ...
    resultDraw: "Draw", draw: "Draw", boardFilled: "Board filled: {red}-{blue} territory.",
    noLegalMoves: "No legal deployments remained: {red}-{blue} territory.",
  ...
  ko: {
    ...
    resultDraw: "무승부", draw: "무승부", boardFilled: "보드 종료: 빨강 {red} - 파랑 {blue}.",
    noLegalMoves: "양쪽 모두 둘 수 없어 종료: 빨강 {red} - 파랑 {blue}.",
