...
- Automatic King-wall taunts expose an authoritative `tauntUntil` timestamp; deployments remain locked until that deadline so clients can render only the remaining presentation time.
